...
Tile::Tile(sf::IntRect intrect, tile::ID Id) : rect(sf::Vector2f(intrect.width, intrect.height)), id(Id)
{
...
sf::Color Tile::IDtoColor(tile::ID id)
{
	...
	case tile::Path:
		return sf::Color(0, 76, 132); //good looking blue
	case tile::Start:
		return sf::Color(200, 50, 50); //good looking red
	case tile::End:
		return sf::Color(250, 150, 100); //orange
	default:
