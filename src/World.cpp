...
World::World(int tileSize, int width, int height, sf::Vector2f startPos, sf::Vector2f endPos) : tileSize(tileSize), horizontalTiles(width / tileSize), width(width), height(height)
{
